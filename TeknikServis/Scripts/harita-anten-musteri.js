    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (key, value) {
                ...
                var musteri_id = objData.musteri_id;
                var bayi = objData.bayi;
                musteriListesi[musteri_id] = { center: new google.maps.LatLng(center_Lat, center_Long), adi: musteri_adi, musteri_id: musteri_id, bayi: bayi };
...
function initializeMusteriler() {
   ...
   "<div class='panel-heading'>" +
     musteriler[musteri].adi + "/" + musteriler[musteri].bayi +
   "</div>" +
   "<div class='panel-body'>" +
       "<div class='table-responsive'>" +
                  "<div class='btn btn-xs-group'>" +
