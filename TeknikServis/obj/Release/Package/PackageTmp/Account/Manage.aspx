<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="TeknikServis.Account.Manage" enableEventValidation="false" validateRequest="false" enableViewStateMac="false" %>
    ...
    <div class="kaydir">
        <div id="panelContents" runat="server" class="panel panel-info">
            <div class="panel-heading">
                <h2 class="baslik">Kullanıcı Hesap Ayarları</h2>
            </div>
            <div>
