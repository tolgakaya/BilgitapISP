<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" EnableEventValidation="false" ValidateRequest="false" AutoEventWireup="true" CodeBehind="Odemeler.aspx.cs" Inherits="TeknikServis.Odemeler" %>
            ...
            <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <button id="btnGoster" runat="server" class="btn btn-info btn-lg btn-block" type="submit" onserverclick="KasaGoster">Göster...</button>
                    </div>
                    <!--body-->
                </div>
            </div>
        ...
        <div class="panel panel-info">
            ...
            <div class="table-responsive">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="odemeTarih" HeaderText="Ödeme Tarihi" HeaderStyle-CssClass="visible-lg visible-xs visible-sm" DataFormatString="{0:d}" ItemStyle-CssClass="visible-lg visible-xs visible-sm">
                            <HeaderStyle CssClass="visible-lg visible-xs visible-sm" />
                            <ItemStyle CssClass="visible-lg visible-xs visible-sm" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="masraf_tipi" HeaderText="Tip" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg">
                            <HeaderStyle CssClass="visible-lg" />
                            <ItemStyle CssClass="visible-lg" />
                        </asp:BoundField>
            ...
            <div class="panel-footer pull-right">
                <div class=" btn-group">
                    ...
                    <asp:Button ID="btnEkle" runat="server" Text="Tahsilat" CssClass="btn btn-info"
                        OnClick="btnEkle_Click" />
                    <asp:Button ID="btnEkle2" runat="server" Text="Ödeme" CssClass="btn btn-info"
                        OnClick="btnEkle2_Click" />
