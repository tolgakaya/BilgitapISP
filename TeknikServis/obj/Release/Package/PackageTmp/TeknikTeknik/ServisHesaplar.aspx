<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" EnableEventValidation="false" ValidateRequest="false" AutoEventWireup="true" CodeBehind="ServisHesaplar.aspx.cs" Inherits="TeknikServis.ServisHesaplar" %>
        ...
        <div class="panel panel-info">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="visible-lg " ItemStyle-CssClass="visible-lg" HeaderStyle-Width="120">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="btnOnayComand"
                                            runat="server"
                    ...
                    <div class="modal-dialog modal-content modal-md">
                        <div class="modal-header modal-header-info">
                            <button type="button" class="close" data-dismiss="modal"
                                aria-hidden="true">
                                ×</button>
                            <h3 id="addModalLabel" class="baslik">Taksit Oluştur</h3>
                        </div>
                            ...
                            <ContentTemplate>
                                <div class="modal-body">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <asp:Label runat="server" AssociatedControlID="txtTutar" CssClass="col-md-4 control-label">Toplam Tutar</asp:Label>
                                            <div class="col-md-8">
                                                <asp:TextBox runat="server" ID="txtTutar" CssClass="form-control" />
                                            </div>
                                        </div>
                                        <asp:HiddenField ID="hdnServisID" runat="server" />
                                        <asp:HiddenField ID="hdnIslem" runat="server" />

                                        <div class="form-group">
                                            <asp:Label runat="server" AssociatedControlID="txtTaksitSayisi" CssClass="col-md-4 control-label">Taksit Sayısı</asp:Label>
                                            <div class="col-md-8">
                                                <asp:TextBox runat="server" ID="txtTaksitSayisi" TextMode="Number" ValidationGroup="grup" CssClass="form-control" />
                                            </div>
                                            <asp:RangeValidator ID="RangeValidator1" runat="server" MaximumValue="99" ValidationGroup="grup" MinimumValue="1" Type="Integer" ControlToValidate="txtTaksitSayisi" ErrorMessage="Lütfen sayı giriniz"></asp:RangeValidator>
                                        </div>
                                        <div class="form-group">
                                            <asp:Label runat="server" AssociatedControlID="txtBaslamaTarihi" CssClass="col-md-4 control-label">Başlama Tarihi</asp:Label>
                                            <div class="col-md-8">
                                                <asp:TextBox runat="server" ID="txtBaslamaTarihi" ValidationGroup="grup" CssClass="form-control" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="grup" ControlToValidate="txtBaslamaTarihi" runat="server" ErrorMessage="Lütfen başlama tarihi giriniz."></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="checkbox-inline">
                                                    ...
                                                    <asp:CheckBox ID="chcSmsTaksit" Text="SMS" runat="server" />
                                                </div>
                                                <div class="checkbox-inline">

                                                    <asp:CheckBox ID="chcMailTaksit" Text="Mail" runat="server" />
                                                </div>
                                ...
                                <div class="modal-footer">
                                    <asp:Button ID="btnAddRecord" runat="server" Text="Kaydet"
                                        CssClass="btn btn-info" OnClick="btnAddRecord_Click" ValidationGroup="grup" CausesValidation="true" />
                ...
                <div id="detailModal" class="modal  fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-content modal-sm">
                        <div class="modal-header modal-header-info">
                            ...
                            <h3 id="myModalLabel" class="baslik">Taksit Detayları</h3>
                        </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover"
                                        DataKeyNames="taksitTarihi" EmptyDataText="Kayıt girilmemiş">
                                        <Columns>

                                            <asp:BoundField DataField="taksitTarihi" HeaderText="Tarih" HeaderStyle-CssClass="visible-lg" DataFormatString="{0:D}" ItemStyle-CssClass="visible-lg"></asp:BoundField>
                                            <asp:BoundField DataField="taksitTutari" HeaderText="Taksit" HeaderStyle-CssClass="visible-lg visible-xs visible-sm" ItemStyle-CssClass="visible-lg visible-xs visible-sm"></asp:BoundField>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                        ...
                                                        <Triggers>
                                                            ...
                                                            <asp:AsyncPostBackTrigger ControlID="btnEkleK" EventName="Click" />
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="panel panel-info">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Karar Bilgileri</a>
                                                    </h4>
                                                </div>
            ...
            <div class="panel-footer">
                <div class=" btn-group  pull-right visible-lg">
                    ...
                    <asp:LinkButton ID="btnServisDetaylari" OnClick="btnServisDetaylari_Click"
                        runat="server" Visible="false"
                        CssClass="btn btn-info "
                        Text="<i class='fa fa-suitcase icon-2x'></i>" />
                    <asp:LinkButton ID="btnServis" OnClick="btnServis_Click"
                        runat="server" Visible="false"
                        CssClass="btn btn-info "
                ...
                <div class=" btn-group pull-right visible-xs visible-sm">
                    ...
                    <asp:LinkButton ID="btnServisK" OnClick="btnServis_Click"
                        runat="server" Visible="false"
                        CssClass="btn btn-info "
                        Text="<i class='fa fa-wrench icon-2x'></i>" />
