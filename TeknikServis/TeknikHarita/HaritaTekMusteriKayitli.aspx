<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HaritaTekMusteriKayitli.aspx.cs" Inherits="TeknikServis.TeknikHarita.HaritaTekMusteriKayitli" %>
...
<head runat="server">
    ...
    <%--   <script src="../Scripts/harita-tek-musteri4.min.js"></script>--%>
    <script src="../Scripts/harita-arc-dep.js"></script>
    <script src="../Scripts/harita-tek-musteri5.js"></script>
