<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ButunAntenMusteri2.aspx.cs" Inherits="TeknikServis.TeknikHarita.ButunAntenMusteri2" %>
...
<head runat="server">
    ...
    <title>Anten-Müşteri Haritası</title>
   ...
   <%-- <script src="../Scripts/harita-anten-musteri3.min.js"></script>--%>
    <script src="../Scripts/harita-arc-dep.js"></script>
     <script src="../Scripts/harita-anten-musteri4.js"></script>
    <link href="../Content/bootstrap.min.css" rel="stylesheet" />
    <link href="../Content/bootstrap-theme.min.css" rel="stylesheet" />
</head>
<body onload="initializeAntenMusteri()">
    <form id="form1" runat="server">
        <div class="panel panel-primary">
            <!-- Default panel contents -->
            <div class="panel-heading">
                ANTENLER VE MÜŞTERİLER
            </div>
            ...
            <div class="panel-footer pull-right">
                <div class="btn-group pull-right hidden-xs hidden-sm">
                    ...
                    <asp:Button ID="Button7" runat="server" Text="Giriş" CssClass="btn btn-primary" OnClick="btnAna_Click" />
                    <asp:Button ID="Button8" runat="server" Text="Geri Dön" CssClass="btn btn-danger" OnClick="btnGeri_Click" />
                    <input type="button" value="Yenile" class="btn btn-success" onclick="document.location.reload(true)" />
                </div>
