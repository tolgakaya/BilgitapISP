<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="MusteriAnten2.aspx.cs" Inherits="TeknikServis.TeknikHarita.MusteriAnten2" %>
                                    ...
                                    <ItemTemplate>
                                        <div class="visible-lg visible-xs visible-sm">
                                            <asp:LinkButton ID="btnTekAnten"
                                                ...
                                                ToolTip="Müşterinin bütün antenler içindeki durumunu gösterir"
                                                Text="<i class='fa fa-map'>Haritada</i>" />
                                            <asp:LinkButton ID="btnTekAnten2"
                                                runat="server"
                                                CssClass="btn btn-danger"
                                                ToolTip="Müşterinin sadece bağlı olduğu antenle durumunu gösterir"
                                                Text="<i class='fa fa-map'>Haritada</i>" />
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
