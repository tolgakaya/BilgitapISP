<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TekAnten.aspx.cs" EnableEventValidation="false" Inherits="BilgitapServis.TekAnten" %>
...
<head runat="server">
    ...
    <%--<script src="../Scripts/harita-tek-anten-geo.min.js"></script>--%>
    <script src="../Scripts/harita-arc-dep.js"></script>
    <script src="../Scripts/harita-tek-anten-geo2.js"></script>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    <div class="btn-group pull-right hidden-xs hidden-sm">
                        <asp:Button ID="btnHaritayaGore" runat="server" Text="Müşteri koordinatlarını kaydet" CssClass="btn btn-primary" OnClick="btnHaritayaGore_Click" />
                        <asp:Button ID="btnAnteneMusteri" runat="server" Text="Kapsamdakileri antene kaydet" CssClass="btn btn-primary" OnClick="btnAnteneMusteri_Click" />
                        <asp:Button ID="Button2" runat="server" Text="Kapsam alanındaki müşteriler" CssClass="btn btn-warning" OnClick="btnMusteriler_Click" />
