<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HaritaMusteriKaydet.aspx.cs" Inherits="TeknikServis.HaritaMusteriKaydet" %>
...
<body onload="initialize()">
    <form id="form1" runat="server">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="btn-group pull-right visible-xs visible-sm">
                    <asp:Button ID="Button6" runat="server" Text="Kaydet" CssClass="btn btn-primary btn-sm" OnClick="btnMusteriKaydet_Click" />
                    <asp:Button ID="Button7" runat="server" Text="Giriş" CssClass="btn btn-info btn-sm" OnClick="btnAna_Click" />
        ...
        <div class="panel-footer pull-right">
            ...
            <div class="btn-group pull-right visible-xs visible-sm">
                <asp:Button ID="Button9" runat="server" Text="Kaydet" CssClass="btn btn-primary btn-sm" OnClick="btnMusteriKaydet_Click" />
                <asp:Button ID="Button10" runat="server" Text="Giriş" CssClass="btn btn-info btn-sm" OnClick="btnAna_Click" />
                <asp:Button ID="Button11" runat="server" Text="Geri" CssClass="btn btn-danger btn-sm" OnClick="btnGeri_Click" />
                <input type="button" value="Yenile" class="btn btn-success btn-sm" onclick="document.location.reload(true)" />
            </div>
        </div>
