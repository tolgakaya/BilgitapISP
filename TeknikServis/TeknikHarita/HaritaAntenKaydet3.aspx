...
<head runat="server">
    ...
    <script src="../Scripts/harita-hazir-anten-kaydet2.js"></script>
                ...
                <div class="table-responsive">
                    <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <label for="txtDondur">Çevirme</label>
                            <input id="txtDondur" runat="server" type="number" class="form-control" placeholder="çevirme açısı" value="5" />
                        </div>
